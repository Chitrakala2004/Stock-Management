    ...
    <div className="space-y-6">
      ...
      {isLedgerModalOpen && selectedCustomer && (
        ...
        >
          <div className="space-y-6">
            {/* Header info */}
            <div className="bg-slate-900 text-white rounded-2xl p-4 sm:p-6 shadow-md relative overflow-hidden">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 relative z-10">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-xl flex items-center justify-center font-bold text-lg sm:text-xl text-white shrink-0">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer"
                >
              ...
              {/* Balances Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-5 pt-5 border-t border-slate-800">
